...
public class Getgroups {
    ...
    @Path("/{a}")
    public String getIt1(@PathParam("a") String grpid){
        System.out.println(grpid);
        return getJSON2(grpid);
    }
    
    public String getJSON2(String input1){
        ...
        try {
            ...
            String sql = "SELECT * FROM register where grpid ='" + input1 + "'";
            ...
            while (RS.next()) {
                ...
                String domain_allot=RS.getString("domain_allot");
                ...
                j.put("domain_allot",domain_allot);
                j.put("guide",guide);
                j.put("title",title);
                array.put(j);
    ...
    public static String getJSON1(String div, String year) throws JSONException {
        ...
        try {
            ...
            stm = con.createStatement();
            System.out.println(div + year);
            String sql = "SELECT * FROM register where divname ='" + div + "' and year='" + year + "' and flag='0'";
            RS = stm.executeQuery(sql);
    ...
    @Produces(MediaType.TEXT_PLAIN)
    @Path("/{a}/{b}/{c}")
    public String getIt2(@PathParam("a") String div, @PathParam("b") String year,@PathParam("c") String id) throws SQLException, JSONException {
        System.out.println(div + year);
        return getJSON3(div, year);
    }

    public static String getJSON3(String div, String year) throws JSONException {
        JSONArray array = new JSONArray();
        try {
            ...
            stm = con.createStatement();
            System.out.println(div + year);
            String sql = "SELECT * FROM register where divname ='" + div + "' and year='" + year + "' and flag='1'";
            RS = stm.executeQuery(sql);
